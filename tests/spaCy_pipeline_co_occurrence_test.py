...
def test_spaCy_co_occurrence_pipeline():
    ...
    checkpoint_filename: str = "./tests/test_data/SSI_2020_1207_pos_csv.zip"
    target_filename = './tests/output/SSI-co-occurrence-JJVBNN-window-9.csv'
    if os.path.isfile(target_filename):
        os.remove(target_filename)

    ssi: CorpusConfig = CorpusConfig.load('./tests/test_data/ssi_corpus_config.yaml').folder(folder='./tests/test_data')
