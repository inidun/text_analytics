import numpy as np
import pandas as pd
import penelope.co_occurrence.vectorizer_glove as vectorizer_glove
import penelope.co_occurrence.vectorizer_hal as vectorizer_hal
import penelope.utility as utility
from penelope.vendor.gensim.utils import build_vocab
...
def compute(
    ...
    for year in range(min_year, max_year + 1):
        ...
        if method == "HAL":
            ...
            vectorizer = vectorizer_hal.HyperspaceAnalogueToLanguageVectorizer(token2id=common_token2id).fit(
            ...
            vectorizer = vectorizer_glove.GloveVectorizer(token2id=common_token2id).fit(docs, size=window_size)
